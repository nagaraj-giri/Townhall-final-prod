  ...
  return (
    <div className="flex flex-col min-h-screen bg-transparent pb-24">
      ...
      <nav className="fixed bottom-0 w-full max-w-md mx-auto bg-white border-t border-gray-100 pb-8 pt-3 px-4 flex justify-between items-center z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.04)]">
        <button onClick={() => navigate('/')} className="flex-1 flex flex-col items-center gap-1 text-[#888888]"><span className="material-symbols-outlined text-[26px]">grid_view</span><span className="text-[9px] font-bold uppercase tracking-tighter">HOME</span></button>
        <button onClick={() => navigate('/admin/users')} className="flex-1 flex flex-col items-center gap-1 text-[#888888]"><span className="material-symbols-outlined text-[26px]">group</span><span className="text-[9px] font-bold uppercase tracking-tighter">USERS</span></button>
        ...
        <button onClick={() => navigate('/profile')} className="flex-1 flex flex-col items-center gap-1 text-[#888888]"><span className="material-symbols-outlined text-[26px]">settings</span><span className="text-[10px] font-bold uppercase tracking-tighter">SYSTEM</span></button>
      </nav>
    </div>
  );
};
