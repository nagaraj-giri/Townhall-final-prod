...
const ProviderDashboard: React.FC<ProviderDashboardProps> = ({ user }) => {
  ...
  useEffect(() => {
    // Fix: Changed listenToQuotes (which does not exist) to listenToQuotesByProvider for efficient real-time updates filtered by user ID.
  ...
  return (
    <div className="flex flex-col min-h-screen pb-24 bg-transparent">
      ...
      <nav className="fixed bottom-0 w-full max-w-md mx-auto bg-white border-t border-gray-100 pb-8 pt-2 px-4 flex justify-between items-center z-50 shadow-soft">
