    ...
    <div className="flex flex-col min-h-screen pb-32 bg-[#FAF9F6]">
      ...
      <header className="px-6 pt-12 pb-6 flex justify-between items-start">
        <div className="space-y-1">
          ...
          <p className="text-[9px] font-normal text-gray-400 uppercase tracking-widest opacity-60">Marketplace Insights Overview</p>
        </div>
        ...
        <div className="bg-white/50 backdrop-blur-md rounded-full p-1 border border-white shadow-sm flex items-center justify-between">
          {['ALL TIME', 'THIS MONTH'].map(f => (
            <button 
              ...
              className={`flex-1 py-2.5 rounded-full text-[10px] font-normal uppercase tracking-widest transition-all ${activeFilter === f ? 'bg-primary text-white shadow-lg' : 'text-text-light'}`}
            >
              {f}
            </button>
          ))}
          <button className="flex-1 py-2.5 text-[10px] font-normal text-text-light uppercase tracking-widest flex items-center justify-center gap-1">
      ...
      <main className="px-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button onClick={() => navigate('/admin/broadcast')} className="bg-primary p-6 rounded-[2rem] shadow-btn-glow flex items-center justify-center gap-3 active:scale-95 transition-all border border-white/10">
            ...
            <span className="text-white text-[11px] font-normal uppercase tracking-widest">Broadcast</span>
          </button>
          <button onClick={() => navigate('/admin/requests')} className="bg-white p-6 rounded-[2rem] shadow-card flex items-center justify-center gap-3 active:scale-95 transition-all border border-white">
            <span className="material-symbols-outlined text-[#FFD60A] text-xl font-normal">gavel</span>
            <span className="text-text-dark text-[11px] font-normal uppercase tracking-widest">Moderation</span>
          </button>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white p-6 rounded-[2rem] shadow-soft border border-white space-y-3">
             <div className="flex justify-between items-start">
                ...
                <span className="text-[8px] font-normal text-accent-green bg-accent-green/10 px-1.5 py-0.5 rounded-md uppercase">+12%</span>
             </div>
             <div>
                <p className="text-[8px] font-normal text-gray-400 uppercase tracking-widest mb-1">Total Customers</p>
                <p className="text-2xl font-normal text-text-dark tracking-tight">{stats.customersCount >= 1000 ? `${(stats.customersCount / 1000).toFixed(1)}k` : stats.customersCount}</p>
             </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-[2rem] shadow-soft border border-white space-y-3">
             <div className="flex justify-between items-start">
                ...
                <span className="text-[8px] font-normal text-accent-green bg-accent-green/10 px-1.5 py-0.5 rounded-md uppercase">+5%</span>
             </div>
             <div>
                <p className="text-[8px] font-normal text-gray-400 uppercase tracking-widest mb-1">Total Providers</p>
                <p className="text-2xl font-normal text-text-dark tracking-tight">{stats.providersCount}</p>
             </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-[2rem] shadow-soft border border-white space-y-3">
             <div className="flex justify-between items-start">
                ...
                <span className="text-[8px] font-normal text-accent-green bg-accent-green/10 px-1.5 py-0.5 rounded-md uppercase">+8.4%</span>
             </div>
             <div>
                <p className="text-[8px] font-normal text-gray-400 uppercase tracking-widest mb-1">Total Queries</p>
                <p className="text-2xl font-normal text-text-dark tracking-tight">{stats.totalQueries.toLocaleString()}</p>
             </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-[2rem] shadow-soft border border-white space-y-3 relative">
             <div className="flex justify-between items-start">
                ...
                <span className="text-[7px] font-normal text-white bg-accent-pink px-2 py-0.5 rounded-full uppercase tracking-tighter shadow-sm">Action</span>
             </div>
             <div>
                <p className="text-[8px] font-normal text-gray-400 uppercase tracking-widest mb-1">Open Queries</p>
                <p className="text-2xl font-normal text-text-dark tracking-tight">{stats.openQueries}</p>
             </div>
          </div>
        </div>
          ...
          <div className="bg-white p-6 rounded-[2.2rem] shadow-soft border border-white space-y-4">
             <div className="flex justify-between items-end">
                <div>
                   ...
                   <p className="text-xl font-normal text-text-dark tracking-tight">924</p>
                </div>
          ...
          <div className="bg-white p-6 rounded-[2.2rem] shadow-soft border border-white space-y-4">
             <div className="flex justify-between items-end">
                <div>
                   ...
                   <p className="text-xl font-normal text-text-dark tracking-tight">14.2k</p>
                </div>
