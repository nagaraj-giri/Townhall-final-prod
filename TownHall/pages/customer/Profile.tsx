    ...
    <div className="flex flex-col min-h-screen bg-transparent pb-32">
      ...
      <main className="flex-1 px-6 space-y-8 overflow-y-auto no-scrollbar pt-2">
                  ...
                  detail.key === 'phone' ? (
                    <div className="flex gap-2 w-full relative">
                      ...
                      >
                        ...
                        <span className="material-symbols-outlined text-xs text-gray-400 font-normal">expand_more</span>
                      </button>
                          ...
                          <div className="absolute top-14 left-0 w-full max-w-[280px] bg-white border border-gray-100 rounded-[1.5rem] shadow-2xl z-50 p-2 max-h-60 overflow-y-auto no-scrollbar animate-in zoom-in-95 duration-200">
                            {COUNTRIES.map(c => (
                              ...
                              >
                                ...
                                <span className="text-[12px] font-normal text-text-dark flex-1 text-left">{c.name}</span>
                                <span className="text-[11px] font-normal text-gray-400">{c.dialCode}</span>
                              </button>
                            ))}
                          </div>
                        </>
                      ...
                      <div className="flex-1 bg-gray-50 rounded-2xl px-5 py-3.5 flex items-center gap-3 shadow-inner border border-gray-100/50">
                        <span className="text-[13px] font-normal text-text-dark shrink-0">{profileData.phoneDial}</span>
                        <div className="w-[1px] h-4 bg-gray-200"></div>
                        <input 
                          type="tel"
                          className="bg-transparent border-none p-0 text-[13px] font-normal text-text-dark outline-none w-full focus:ring-0"
                    ...
                    <div className="relative w-full">
                      ...
                      >
                        ...
                        <span className="text-[13px] font-normal text-text-dark flex-1 text-left">{profileData.nationality || 'Select Nationality'}</span>
                          ...
                          <div className="absolute top-14 left-0 w-full bg-white border border-gray-100 rounded-[2rem] shadow-2xl z-50 p-2 max-h-60 overflow-y-auto no-scrollbar animate-in zoom-in-95 duration-200">
                            {COUNTRIES.map(c => (
                              ...
                              >
                                ...
                                <span className="text-[13px] font-normal text-text-dark flex-1 text-left">{c.name}</span>
                              </button>
                            ))}
                          </div>
                        </>
        ...
        <div className="text-center pt-4 opacity-20">
           <p className="text-[9px] font-normal uppercase tracking-widest">v1.1.0 - Production Build</p>
        </div>
      </main>
